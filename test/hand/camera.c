...
const char *serverUrl = "https://test.wanghaonet.com/yushandevops/embedded/uploadImage";
...
void takeAndUploadPhoto() {
  ...
  Serial.printf("Got image of size: %u bytes\n", fb->len);
  ...
  if (WiFi.status() == WL_CONNECTED) {
    ...
    Serial.println("WiFi disconnected, skip upload");
  }
